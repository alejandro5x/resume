...
\personalinfo{%
  ...
  \email{alxgb10@gmail.com}
  \phone{+507 64001125}
  \mailaddress{Linda Vista Calle H-22}
  \location{Panama City, PANAMA}
  %%\homepage{www.homepage.com}
  %%\twitter{@twitterhandle}
  \linkedin{www.linkedin.com/in/alejandroguerrab}
  \github{https://github.com/alejandro5x}
...
\cvevent{Application System Specialist}{HCL Technologies}{Aug 2020 -- Oct 2022}{Panama}
\begin{itemize}
...
\cvevent{IT Manager CCA}{Stanley Black \& Decker}{Jan 2007 -- Aug 2020}{Panama}
\begin{itemize}
...
\cvevent{Project Engineer}{Arango Software International}{Jan 1998 -- Dec 2007}{Panama}
\begin{itemize}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  3/8em/accent!80/Home Lab,
  8/8em/accent!50/Daytime job,
  2/10em/accent/Tennis and relaxation,
  5/6em/accent!20/Family time
}
...
\cvskill{Progress 4GL}{5}
\divider

\cvskill{PL/SQL}{5}
\divider

\cvskill{Oracle Database}{4}
\divider

\cvskill{Oracle Forms/Report}{5}
\divider
...
\cvevent{Computer System Engineer}{Universidad Tecnologica de Panama}{Jan 1993 -- Dec 1998}{}
%%%%Thesis title: Wonderful Research

\divider

\cvevent{MBA\ Business Administration}{Universidad Latina de Panama}{Jan 2012 -- Jun 2013}{}
